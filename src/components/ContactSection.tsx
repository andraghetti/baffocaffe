...
import { MapPin, Clock, Mail, Download } from "lucide-react";
    ...
    <section className="py-20 px-6 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="mb-8">
            ...
            >
              ...
              >
                ...
                Visualizza il listino del Baffo
              </a>
            </Button>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <a href="https://maps.app.goo.gl/yzrPR569VejZtMTs6" target="_blank" rel="noopener noreferrer" className="block">
            <Card className="h-full p-6 text-center shadow-soft border-0 bg-card hover:shadow-warm transition-all duration-300 hover:-translate-y-2 cursor-pointer flex flex-col">
              ...
              <p className="text-muted-foreground hover:text-accent transition-colors flex-grow">
          ...
          <a href={`https://wa.me/${siteConfig.contact.whatsapp.replace(/\s/g, '').replace('+', '')}`} target="_blank" rel="noopener noreferrer" className="block">
            <Card className="h-full p-6 text-center shadow-soft border-0 bg-card hover:shadow-warm transition-all duration-300 hover:-translate-y-2 cursor-pointer flex flex-col">
              <div className="w-16 h-16 bg-gradient-to-br from-coffee-medium to-coffee-dark rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="h-full p-6 text-center shadow-soft border-0 bg-card hover:shadow-warm transition-all duration-300 hover:-translate-y-2 flex flex-col">
            <div className="w-16 h-16 bg-gradient-to-br from-coffee-medium to-coffee-dark rounded-full flex items-center justify-center mx-auto mb-4">
              <Clock className="w-8 h-8 text-cream" />
            </div>
            <h3 className="text-xl font-semibold text-coffee-dark mb-3">Orari</h3>
            <div className="text-muted-foreground text-sm whitespace-pre-line flex-grow">
              {siteConfig.hours}
            </div>
          </Card>
